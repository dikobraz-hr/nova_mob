  ...
  <q-layout view="lHh Lpr lFf">
    <div class="row">
      ...
      <div class="col-12 justify-center items-center text-center q-mt-lg">
        ...
        <router-link to="/"> <q-img src="horizontal-logo.png" width="200px"
            class="q-mt-xl q-mx-auto block"></q-img></router-link>
      </div>
    </div>
    ...
    <div class="bottom-toolbar q-pb-xl">
      ...
      <button class="toolbar-btn" :class="{ active: activeTab === 1 }" @click="goTo('/category-all')"
        aria-label="Categories">
        <q-icon name="category" />
        <span>{{ $t('Categories') }}</span>
      </button>
      <button class="toolbar-btn" :class="{ active: activeTab === 3 }" @click="goTo('/game')" aria-label="game">
        <div class="custom-icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            <path
              d="M182.15-140 140-182.15 445.23-488l-174.84-43.08L453-644.46 437.16-860l164.76 139.08L801-802l-80.08 199.69L860-438.16 644.46-453l-114 182.61L487-445.23 182.15-140Zm23.62-523.85L140-729.62l65.77-65.76 65.77 65.76-65.77 65.77ZM555-422.61l57.23-93.24 109.54 8.16L651-591.77l41.16-101.39L590.77-652l-84.08-70.16 8.16 108.93L422-555.38l106.15 26.23L555-422.61ZM729.62-140l-65.77-65.77 65.77-65.77 65.76 65.77L729.62-140ZM572.08-572.69Z" />
          </svg>
        </div> <span>{{ $t('Game') }}</span>
      </button>
      <button class="toolbar-btn" :class="{ active: activeTab === 2 }" @click="goTo('/profile')" aria-label="Profile">
        <q-icon name="person" />
        <span>{{ $t('profile') }}</span>
      </button>
    </div>
...
.hamburger-btn {
  ...
  left: 8px;
  z-index: 4001;
  /*.qdrawer po defaultu ima zindex 1000, a na mobile 3000 */
}
